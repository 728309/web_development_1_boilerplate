...
<head>
    ...
    <title>Login - SK Production Hub</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5">
                <div class="detail-box p-4">
                    <p class="text-accent text-uppercase fw-bold small mb-2">Account Access</p>
                    ...
                    <div class="mt-4 text-secondary small">
                        Demo login:<br>
                        admin@skhub.local / Password123!
                        <br><br>
                        No account yet?
                        <a href="/register" class="text-accent">Register here</a>
                    </div>
                </div>
            </div>
        </div>
